    ...
    <main className="min-h-screen bg-[#050505] text-white p-8">
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-12">
          ...
          <Link
            href="/auth/signout"
            className="flex items-center gap-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 px-4 py-2 rounded-lg transition-all text-zinc-400 hover:text-white"
          >
        ...
        <div className={isAdmin ? "grid md:grid-cols-3 gap-8" : "max-w-md mx-auto"}>
          {/* User Profile Card */}
          <div className={`${isAdmin ? "md:col-span-1" : "w-full"} border border-zinc-800 bg-zinc-900/30 backdrop-blur-md rounded-3xl p-8`}>
